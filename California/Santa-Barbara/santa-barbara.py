...
cookies = {
    'cookie':'_fbp=fb.1.1732719145905.970665413435819424; __gads=ID=066df7c9f805d0b3:T=1732719147:RT=1732720824:S=ALNI_MaUn2Nyc0if2r7-vzX0Ow3A0qwrXw; __gpi=UID=00000fa0e14b80e0:T=1732719147:RT=1732720824:S=ALNI_MbjpaJ8d-55yxRyAl0iZqWswNoz5w; __eoi=ID=70000d19886f33bf:T=1732719147:RT=1732720824:S=AA-AfjZPr-qUY89iT8DMSZzneevN'
}
...
headers = {
    ...
    'dnt': '1',
    'priority': 'u=0, i',
    'referer': 'https://santabarbaramoms.com/resources/',
...
response = requests.get('https://santabarbaramoms.com/resources/sweets/',  cookies=cookies, headers=headers)
