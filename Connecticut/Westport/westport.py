...
def setup_browser():
    ...
    browser.get("https://westportmoms.com")
...
def open_to_website(browser):
    ...
    browser.get("https://westportmoms.com/resources/activities-attractions/")
    time.sleep(10)
    ...
    reviews_1 = soup.find_all('div', class_=['entry-content'])
