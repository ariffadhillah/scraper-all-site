...
headers = {
    ...
    'dnt': '1',
    'priority': 'u=0, i',
    'referer': 'https://littlerockmomsnetwork.com/resources/',
...
response = requests.get('https://littlerockmomsnetwork.com/resources/Schools/',  cookies=cookies, headers=headers)
