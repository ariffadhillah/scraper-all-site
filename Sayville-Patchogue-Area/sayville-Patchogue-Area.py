...
response = requests.get('https://sayvillepatchoguemoms.com/resources/childrens-activities/',  cookies=cookies, headers=headers)
...
filename = "Childrens-activities.csv"

# Menulis data ke dalam file CSV
with open(filename, mode='w', newline='', encoding='utf-8') as file:
    writer = csv.DictWriter(file, fieldnames=['name', 'url', 'address','Email'])
