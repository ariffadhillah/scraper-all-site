...
headers = {
    ...
    'dnt': '1',
    'priority': 'u=0, i',
    'referer': 'https://scarsdalemom.com/resources/',
...
response = requests.get('https://scarsdalemom.com/resources/pediatric-dentists/',  cookies=cookies, headers=headers)
...
filename = "Pediatric Dentists.csv"
