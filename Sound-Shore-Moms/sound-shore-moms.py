...
response = requests.get('https://soundshoremoms.com/resources/pediatricians-specialists/',  cookies=cookies, headers=headers)

soup = BeautifulSoup(response.content, 'html.parser')

results = []

title_name = 'Pediatricians Specialists'
